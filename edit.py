...
def main():
    ...
    # Factorize weights.
    generator = load_generator(args.checkpoint_path, args.model_name)
    ...
    save_dir = os.path.join(args.save_dir, args.checkpoint_path.split('/')[-3], f's{args.start_distance}e{args.end_distance}',version)
