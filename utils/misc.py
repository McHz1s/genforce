...
__all__ = [
    'init_dist', 'bool_parser', 'DictAction', 'parse_config', 'update_config', 'postprocess', 'load_generator',
    'factorize_weight',
    'HtmlPageVisualizer'
]
...
def post_process(batch_img_tensor, normalize=False, return_tensor=False, transpose=False):
    """
    ...
    if transpose:
        re_batch_img = np.transpose(re_batch_img, [0, 2, 3, 1])
    if return_tensor:
